    ...
    const menuItems = [
        {
            ...
            subtitle: 'Institutional details & contact info',
            icon: 'business-outline',
            color: Colors.primary,
            onPress: () => router.push('/(app)/clinic-profile'),
            hide: !isAdmin
        },
        {
            id: 'hours',
            title: 'Operational Hours',
            subtitle: 'Weekly availability & scheduling',
            icon: 'time-outline',
            color: Colors.primary,
            onPress: () => router.push('/(app)/clinic-hours'),
            hide: !isAdmin
        },
        {
            id: 'security',
        ...
        },
        {
            ...
            subtitle: 'Technical assistance & bug reporting',
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                <View style={styles.profileSummary}>
                    <View style={styles.avatarWrap}>
                        <View style={styles.avatar}>
                            <Text style={styles.avatarText}>{user?.email?.[0]?.toUpperCase() || 'C'}</Text>
                        </View>
                    ...
                    <View style={styles.profileInfo}>
                        <Text style={styles.roleLabel}>{user?.role?.replace('_', ' ')}</Text>
                ...
                <View style={styles.footerActions}>
                    ...
                    <Text style={styles.versionTag}>Medical Zen Enterprise v1.2.0</Text>
                    <Text style={styles.legalLinks}>Terms of Service • Privacy Policy</Text>
                </View>
